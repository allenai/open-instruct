...
uv run python mason.py \
       ...
       --mount_docker_socket \
       -- git clone --depth 1 https://github.com/open-thoughts/OpenThoughts-TBLite.git /tmp/tblite \&\& python scripts/train/inject_host_networking.py /tmp/tblite \&\& source configs/beaker_configs/ray_node_setup.sh \&\& python open_instruct/grpo_fast.py \
