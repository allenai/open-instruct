python mason.py \
    --cluster ai2/jupiter \
    --image hamishivi/open_instruct_rl_rag_testing20 \
    --pure_docker_mode \
    --budget ai2/oe-adapt \
    ...
    --env OPENAI_API_BASE=http://ceres-cs-aus-447.reviz.ai2.in:8003/v1 \
    --env LITELLM_MAX_CONCURRENT_CALLS=32 \
    --env LITELLM_DEFAULT_TIMEOUT=600 \
    --env LITELLM_LOG=DEBUG \
    -- source configs/beaker_configs/ray_node_setup.sh \&\& python open_instruct/grpo_fast.py \
        --exp_name 1011_rl_rag_final_run_open_judge_${RANDOM} \
