python mason.py \
    --cluster ai2/augusta \
    --task_name sft_qwen3-4b-inst_v1_simple_with_mix \
    --description "SFT Qwen3-4B, v1 simple template, with general data" \
    ...
    --hf_repo_id sft_qwen3-4b-inst_v1_simple_with_mix \
    --exp_name sft_qwen3-4b-inst_v1_simple_with_mix \
    ...
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/sft_qwen3-4b-inst_v1_simple_with_mix_checkpoints \
    --max_seq_length 8192 \
