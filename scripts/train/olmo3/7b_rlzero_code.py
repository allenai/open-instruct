...
def main(run_local: bool = False, beaker_image: str = "open-instruct-integration-test"):
    ...
    eval_dataset_config = DatasetConfig(
        dataset_mixer_list=["allenai/Dolci-RLZero-Code-7B", "8"],
        dataset_mixer_list_splits=["train"],
        max_prompt_token_length=2048,
    )
    ...
    args = Args(
        ...
        oe_eval_tasks="codex_humanevalplus:0-shot-chat::tulu-thinker_deepseek,mbppplus:0-shot-chat::tulu-thinker_deepseek,livecodebench_codegeneration::tulu-thinker_deepseek_lite",
        eval_on_step_0=True,
