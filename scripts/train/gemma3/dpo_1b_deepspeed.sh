# DPO training for Gemma-3 1B using DeepSpeed ZeRO Stage 2
#
# Effective batch size: per_device_train_batch_size * gradient_accumulation_steps * num_gpus
# Current config (4 GPUs): 4 * 8 * 4 = 128
#
# Usage:
#   Single GPU:  ./scripts/train/gemma3/dpo_1b_deepspeed.sh
#   Multi GPU:   ./scripts/train/gemma3/dpo_1b_deepspeed.sh 4
...
accelerate launch \
    ...
    --weight_decay 0.0 \
    --num_epochs 1 \
    --output_dir output/gemma_3_1b_dpo_deepspeed/ \
    --with_tracking \
    --report_to wandb \
    --logging_steps 1 \
    --use_lora False \
    ...
    --hf_repo_id gemma-3-1b-vanilla-dpo-123-seed \
