...
Updated 2026-09-18 02:45Z (details in the latest Log entries).
...
- Blocked on Kevin: step 4 baseline arms and the EOPD A/B (compute sign-off, see "Open questions");
  step 2c skip proposal and step 2d decision.
