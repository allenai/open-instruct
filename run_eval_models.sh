...
MODEL_NAMES=(
    "two_stage_router_sfted_experts"
)

MODEL_PATHS=(
    "/weka/oe-training-default/sanjaya/flexolmo/checkpoints/OLMo2-7b-flex-base-merged-math-code-experts-sft-math-mixed-RT-supervised-router-basic-regularRT/step9537-hf"
)
