...
python mason.py \
    ...
    --exp_name yolojm-dpo-delta_qwen3_32b_0.6b_5e-7_mix0.4 \
    --model_name_or_path $MODEL_NAME \
    --tokenizer_name $MODEL_NAME \
    --use_slow_tokenizer False \
    --dataset_mixer_list scottgeng00/olmo2_delta_qwen3_32b_vs_0.6b 0.4 allenai/olmo-2-1124-7b-preference-mix 1.0 \
    --max_seq_length 2048 \
