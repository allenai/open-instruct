...
EXP_NAME=sm4-0912-dpo-delta100k_grafcode-gpt150k_c35-5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_victoria_hates_code 100000 \
        allenai/dpo-chat35-150k-gpt4.1-judge-2weak2strong-maxdelta_rejected 150000 \
    --max_seq_length 4096 \
