...
### Added
- Add Qwen3-MoE GRPO support with live ZeRO-3 weight synchronization, dependency-compatible CUDA images, isolated GPU coverage, and DAPO launch configurations (https://github.com/allenai/open-instruct/pull/1791).
