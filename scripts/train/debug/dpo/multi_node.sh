...
LR=1e-6
EXP_NAME=olmo2-7b-DPO-debug-16k-packing-bs8-noshard-${LR}

uv run python mason.py \
    --cluster ai2/saturn \
    --cluster ai2/jupiter \
    --description "2 node DPO run with OLMo2-7B, 16k seq len, bs=8, no shard_degree (packing + compile). Longer run for MFU comparison." \
