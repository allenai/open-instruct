...
#     --name vllm_judge_olmo3_pretrain_ckpt_10pct \
#     --workspace ai2/oe-data

JUDGE_BASE_URL=http://ceres-cs-aus-446.reviz.ai2.in:8003/v1

python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_olmo3_pretrain_ckpt_25pct \
    --description "GRPO Olmo-3, 25% pretrain" \
    --workspace ai2/oe-data \
    --priority normal \
    ...
    --exp_name grpo_olmo3_pretrain_ckpt_25pct \
    --beta 0.0 \
    ...
    --model_revision stage1-step353000 \
    --tokenizer_name allenai/Olmo-3-1025-7B \
    --tokenizer_revision stage1-step353000 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_ckpt_25pct_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_ckpt_25pct_checkpoints \
    --save_freq 100 \
    --keep_last_n_checkpoints 10 \
    --gradient_checkpointing \
    --with_tracking \
    --hf_entity yapeichang \
    --hf_repo_id grpo_olmo3_pretrain_ckpt_25pct \
