...
EXP_NAME=retrojm-dpo-gpt4.1-base_2w2s_random0.5-lr5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/dpo-base-100k-gpt4.1-judge-2weak2strong-random_rejected_margin0.5 1.0 \
    --max_seq_length 4096 \
