...
[the merge evidence](../olmo3-merge-20260912.json).
...
[the rebase/preflight record](../olmo3-rebase-20260912.json).
...
[the launch and preparation record](../olmo3-gsm8k-20260912.json)
...
[`measurements/miles-olmo3-yarn-20260912.json`](../olmo3-yarn-20260912.json).
...
Use the existing [Dolci preparation proposal](../../plans/dolci-production-proposal.md)
and [managed judge workflow](../../managed-judges.md), rebuilding with the dense
...
[miles-workflow.md](../../workflow.md). GPU candidates use Holmes,
...
[the run measurement](../olmo3-gsm8k-20260912.json).
