...
gs_model_name="Olmo-3-7B-Instruct-DPO"
...
python mason.py \
    ...
    --output_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-dpo-random \
    --checkpoint_state_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-dpo-random_states \
