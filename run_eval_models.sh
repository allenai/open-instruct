...
MODEL_NAMES=(
    "merged-RT-experts-sft-math-mixed-2-experts"
)

MODEL_PATHS=(
    "/weka/oe-training-default/sanjaya/flexolmo/checkpoints/OLMo2-7b-flex-base-merged-math-code-RT-experts-sft-math-mixed-2-experts/step9537-hf"
)
