python /net/nfs.cirrascale/mosaic/nouhad/projects/open-instruct/mason.py \
    ...
    --preemptible \
    --budget ai2/allennlp \
    --beaker_datasets /model:01J6DC8YQ291QA3QEYQTM3CBHE /reward_model:01J8N1PPBMRRGH65RV1KR2SYBF \
    ...
    --dataset_mixer '{"allenai/ultrafeedback_binarized_cleaned_train: 1.0": 1.0, "ai2-adapt-dev/DaringAnteater-prefs-RM-filter": 1.0, "ai2-adapt-dev/only_wildchat_aug28_regenerated_llama": 1.0, "ai2-adapt-dev/PKU-SafeRLHF-processed": 1.0}' \
