...
python scripts/submit_finetune_job.py \
  ...
  --config configs/train_configs/sft/safety_mix/llama3-8b-finalresp-20k-wildgaurdmixtrain-mixv3.4.yaml \
  --exp_name nd-SFT-llama3-8b-20k-wildgaurdmixtrain-mixv3.4
