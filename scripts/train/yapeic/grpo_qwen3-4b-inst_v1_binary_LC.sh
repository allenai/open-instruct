...
#     --name vllm_judge_qwen3-4b_v1_binary_LC \
...
python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_qwen3-4b-inst_v1_binary_LC_sym_r3 \
    --description "GRPO Qwen3-4B, v1 binary (length control symmetric) r3" \
    --workspace ai2/oe-data \
    --priority high \
    ...
    --exp_name grpo_qwen3-4b-inst_v1_binary_LC_sym_r3 \
    --beta 0.0 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_qwen3-4b-inst_v1_binary_LC_sym_r3_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_qwen3-4b-inst_v1_binary_LC_sym_r3_checkpoints \
    --save_freq 100 \
    ...
    --hf_repo_id grpo_qwen3-4b-inst_v1_binary_LC_sym_r3 \
