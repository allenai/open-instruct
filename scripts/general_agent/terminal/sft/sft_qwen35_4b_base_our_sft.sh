...
# SFT on Qwen3.5-4B using osieosie/tmax-sft-skill-tax-20260505-2.2k-combined-balanced-qwen3.6-27b-thinking
...
MODEL=hamishivi/Qwen3.5-4B-Base
TOKENIZER=hamishivi/Qwen3.5-4B-Base
...
uv run python mason.py \
    ...
    --exp_name terminal_sft_qwen35_4b_base_our_sft \
