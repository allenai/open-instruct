...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Process WildChat dataset and optionally upload to Hugging Face Hub."
    )
    parser.add_argument(
        "--push_to_hub",
        action="store_true",
    ...
    convert_sft_dataset(
        ...
        converted_dataset_name="wildchat_gpt4_converted" \
            if not args.converted_dataset_name else args.converted_dataset_name + "_gpt4",
    ...
    convert_sft_dataset(
        ...
        converted_dataset_name="wildchat_gpt35_converted" \
            if not args.converted_dataset_name else args.converted_dataset_name + "_gpt35",
        local_save_dir=args.local_save_dir,
