...
def main(run_local: bool = False, beaker_image: str = "nathanl/open_instruct_auto"):
    ...
    data_mix = [
        "hamishivi/math_rlvr_mixture_dpo",
        "1.0",
        "hamishivi/code_rlvr_mixture_dpo",
        "1.0",
        "hamishivi/IF_multi_constraints_upto5_filtered_dpo_0625_filter",
        "30186",
        "allenai/rlvr_general_mix-keyword-filtered",
        "21387",
    ]
    model_path = "/weka/oe-adapt-default/hamishi/model_checkpoints/olmo3-merge-32b-1e-4-5e-5/olmo3-merge-32b-1e-4-5e-5/"
    exp_name = "test_olmo3_32b_rl_run"
    ...
    launch_config = LaunchConfig(
        ...
        env=[
            ...
            {"name": "LD_LIBRARY_PATH", "value": "/var/lib/tcpxo/lib64"},
            {"name": "NCCL_LIB_DIR", "value": "/var/lib/tcpxo/lib64"},
