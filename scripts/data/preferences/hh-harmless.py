...
def main(push_to_hub: bool, hf_entity: str | None):
    ...
    if push_to_hub:
        if hf_entity:
            repo_id = f"{hf_entity}/hh-rlhf-harmless"
        else:
            repo_id = "hh-rlhf-harmless"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process HH-RLHF dataset and optionally upload to Hugging Face Hub.")
