...
### Fixed
- Restore deprecated `--gradient_checkpointing` flag for DPO as an alias that sets `--activation_memory_budget 0.5`, preventing argparse crashes in launch scripts that still pass the removed flag (LINK_TO_PR).
