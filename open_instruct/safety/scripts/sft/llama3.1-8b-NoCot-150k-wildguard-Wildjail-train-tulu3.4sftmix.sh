python scripts/submit_finetune_job.py \
  ...
  --config configs/train_configs/sft/safety_mix/llama3-8b-150k-wildgaurdmix-WildJail-mixv3.4.yaml \
  --exp_name  nd-SFT-llama3-8b-150k-wildgaurdmix-Wildjail-mixv3.4
