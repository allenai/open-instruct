...
export EXP_NAME="${EXP_NAME:-qwen3_4b_base_dapo_difficulty_curriculum_adaptive_light_hardest50}"
...
exec bash "${SCRIPT_DIR}/qwen3_4b_dapo_math_dc_adaptive_light.sh" "$@"
