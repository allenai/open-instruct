...
# model_name_or_path="/weka/oe-training-default/ai2-llm/checkpoints/sanjaya/olmo2-7B-sft/math_expert_sft_mixed/step1062-hf"
# model_name_or_path="/weka/oe-training-default/ai2-llm/checkpoints/jacobm/flex2-7B-sft/flexolmo-2x7b-DPO-math-and-general-1e-6-unfrozen"
# model_name_or_path="/weka/oe-training-default/ai2-llm/checkpoints/jacobm/flex2-7B-sft/flexolmo-2x7b-DPO-math-and-general-1e-6/"
model_name_or_path="/weka/oe-training-default/ai2-llm/checkpoints/jacobm/olmo2-7B-sft/olmo2-7b-BASE-general-olmo2_math-mix/step1062-hf"
# cluster
cluster=ai2/jupiter
#template
...
# LR=1e-6
LR=6e-7
gs_model_name="flex-base-7b-ol2_math-no-anneal-${LR}-unf"
