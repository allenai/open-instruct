...
### Added
- Support GRPO training of the OLMo-hybrid small suite (`olmo_hybrid_small` architecture): pin transformers + vLLM to the maintainer forks via `[tool.uv.sources]`, plus a single-GPU debug script for the 275M SFT checkpoint (https://github.com/allenai/open-instruct/pull/TODO).
