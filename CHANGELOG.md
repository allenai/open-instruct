...
### Changed
- Export `SETUPTOOLS_SCM_PRETEND_VERSION_FOR_OPEN_INSTRUCT=0.0.0+debug` in all `scripts/train/debug/**/*.sh` launch scripts so local Ray debug runs resolve the package version without a git checkout (https://github.com/allenai/open-instruct/pull/1696).
