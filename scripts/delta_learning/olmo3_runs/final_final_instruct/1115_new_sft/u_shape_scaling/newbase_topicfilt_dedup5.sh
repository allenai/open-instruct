...
for DS_SCALE in 25000 200000
do
    EXP_NAME=olmo3-7b-DPO-1115-nb-tpc-d5-1e-6-${DS_SCALE}
    uv run python mason.py \
       ...
       --gs_model_name olmo3-7b-instruct-SFT-1115 \
        ...
        --dataset_mixer_list allenai/olmo-3-pref-mix-deltas-complement2-DECON-tpc-kwd-ch-dedup5yolo_victoria_hates_code 1.0 \
        --max_train_samples $DS_SCALE \
