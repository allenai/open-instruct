python mason.py \
    --cluster ai2/jupiter \
    --task_name distill_judge_qwen3-8b_sft_v8 \
    --description "distill judge (v8 data)" \
    ...
    --hf_repo_id distill_judge_qwen3-8b_sft_v8 \
    --exp_name distill_judge_qwen3-8b_sft_v8 \
    ...
    --dataset_mixer_list yapeichang/gpt-5-minimal_v9_train_balanced_33362 1.0 \
