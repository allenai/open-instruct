export mixin_it_up="hamishivi/math_rlvr_mixture_sft 1.0 hamishivi/code_rlvr_mixture_sft 1.0 hamishivi/IF_multi_constraints_upto5_filtered_sft_0625_filter 51673 hamishivi/rlvr_general_mix 23110"

export exp_name=olmo3_sft_2510_rl_sft_data_${RANDOM}
...
python mason.py \
    ...
    --env HOSTED_VLLM_API_BASE=http://saturn-cs-aus-248.reviz.ai2.in:8001/v1 \
    -- source configs/beaker_configs/ray_node_setup.sh \&\& source configs/beaker_configs/code_api_setup.sh \&\& python open_instruct/grpo_fast.py \
        ...
        --pack_length 35840 \
        --model_name_or_path /weka/oe-adapt-default/saumyam/checkpoints/olmo2-7B-sft/rl-sft/olmo2.5-6T-LC-sigma-reasoning-mix-decontam-v2-special-tokens-v3-think-FIX \
