...
class PythonCodeTool(Tool):
    ...
    async def _execute(self, code: str, **_kwargs) -> ToolOutput:
...
class JinaBrowseTool(Tool):
    ...
    async def _execute(self, url: str, **_kwargs) -> ToolOutput:
...
class S2SearchTool(Tool):
    ...
    async def _execute(self, query: str, **_kwargs) -> ToolOutput:
...
class DrAgentMCPTool(Tool):
    ...
    async def _execute(self, text: str, **_kwargs) -> ToolOutput:
