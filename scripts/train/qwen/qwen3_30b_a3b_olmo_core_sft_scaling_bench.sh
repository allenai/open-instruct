...
EXP_NAME="qwen3-30b-a3b-olmo-core-sft-32k-bench-${NUM_NODES}n-mb${PER_DEVICE_TRAIN_BATCH_SIZE}-ga${GRADIENT_ACCUMULATION_STEPS}-compile${COMPILE_MODEL}-recompute${MOE_RECOMPUTE_EACH_BLOCK}-internal${MOE_CHECKPOINT_BLOCK_INTERNALS}-${MOE_EXPERT_PARALLEL_PATH}-cap${MOE_EXPERT_PARALLEL_CAPACITY_FACTOR}"
