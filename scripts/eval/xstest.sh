...
# python -m eval.xstest.run_eval \
#     --data_dir data/eval/xstest/ \
#     --save_dir results/xstest/tulu-7B-dpo \
#     --model ../checkpoints/tulu2/7B-dpo \
#     --tokenizer ../checkpoints/tulu2/7B-dpo \
#     --use_chat_format \
#     --chat_formatting_function eval.templates.create_prompt_with_tulu_chat_format \
#     --use_vllm
...
# python -m eval.xstest.run_eval \
#     --data_dir data/eval/xstest/ \
#     --save_dir results/xstest/tulu-70B-sft \
#     --model ../checkpoints/tulu2/70B-sft \
#     --tokenizer ../checkpoints/tulu2/70B-sft \
#     --use_chat_format \
#     --chat_formatting_function eval.templates.create_prompt_with_tulu_chat_format \
#     --use_vllm
