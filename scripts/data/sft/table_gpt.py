...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Process Table-GPT dataset and optionally upload to Hugging Face Hub."
    )
    ...
    readme_content = (
        "This is a converted version of the Table-GPT dataset into Tulu SFT training format.\n\n"
        "The conversion script can be found in our "
        "[open-instruct](https://github.com/allenai/open-instruct/blob/main/scripts/data/sft/table_gpt.py) repo.\n"
        ...
        "Please refer to the [original dataset](https://huggingface.co/datasets/LipengCS/Table-GPT) "
        "for more information about this dataset and the license."
    )

    ds = load_dataset("LipengCS/Table-GPT", "All", num_proc=open_instruct_utils.max_num_processes())
    convert_sft_dataset(
        ds=ds,
        hf_dataset_id=None,
