...
dataset_mix="jacobmorrison/rlvr_math_id 100"
...
gs_model_name="Olmo-3-7B-Instruct-SFT"

exp_name="test_exp_small"
...
uv run python mason.py \
    ...
    --workspace ai2/flex2 \
    --priority urgent \
    --image jacobm/open_instruct_dev_random_rewards10 \
    --preemptible \
    --num_nodes 3 \
    ...
    --pack_length 6144 \
    --model_name_or_path jacobmorrison/Olmo-3-7B-Instruct-DPO-do-sample \
    ...
    --output_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-dpo-random-small \
    --checkpoint_state_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-dpo-random_states_small \
