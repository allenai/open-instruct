...
#     --name vllm_judge_olmo3_pretrain_ckpt_50pct \
#     --workspace ai2/oe-data

JUDGE_BASE_URL=http://ceres-cs-aus-449.reviz.ai2.in:8003/v1

python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_olmo3_pretrain_ckpt_50pct \
    --description "GRPO Olmo-3, 50% pretrain" \
    --workspace ai2/oe-data \
    --priority normal \
    ...
    --exp_name grpo_olmo3_pretrain_ckpt_50pct \
    --beta 0.0 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_ckpt_50pct_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_ckpt_50pct_checkpoints \
    --save_freq 100 \
    --keep_last_n_checkpoints 10 \
    --gradient_checkpointing \
    --with_tracking \
    --hf_entity yapeichang \
    --hf_repo_id grpo_olmo3_pretrain_ckpt_50pct \
