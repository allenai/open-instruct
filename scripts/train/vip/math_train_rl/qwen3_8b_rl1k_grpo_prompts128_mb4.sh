#!/bin/bash
# RL: GRPO baseline matched to the Qwen3-8B VAPO p128/mb4 script, with
# 128 prompts per step and 4 minibatches.
#
# GPU layout: 2 nodes x 8 GPUs = 8 learner GPUs + 8 vLLM inference GPUs.
#
# Step budget:
#   total_episodes = 1000 RL steps * 128 prompts * 8 samples
#                  = 1024000
DDMM=$(date +"%d%m")
exp_name=vip_rl1k_grpo_p128_mb4_${DDMM}_qwen3_8b_math
