...
# OPD: push the released tmax-4b further by pure-distilling from the released
# tmax-27b teacher on the tmax-15k terminal tasks.
#
...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "OPD: tmax-4b student <- tmax-27b teacher (pure distill; 4-node; 32k; terminal sandbox)" \
       --pure_docker_mode \
