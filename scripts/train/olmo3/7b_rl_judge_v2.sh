...
MODEL_NAME_OR_PATH="/weka/oe-adapt-default/yikew/olmo/Olmo-3-7B-Think-DPO"
...
EVALS="alpaca_eval_v3::hamish_zs_reasoning_deepseek,mmlu:cot::hamish_zs_reasoning_deepseek,minerva_math_500::hamish_zs_reasoning_deepseek,ifeval::hamish_zs_reasoning_deepseek"

JUDGE_BASE_URL=http://saturn-cs-aus-252.reviz.ai2.in:8001/v1

EXP_NAME="grpo_general_judge_think"
