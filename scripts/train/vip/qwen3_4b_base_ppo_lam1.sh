#!/bin/bash
# Qwen3-4B-Base PPO with lambda=1.0, no decoupled/adaptive GAE
# 16 value mini-batches per step, value LR 5e-6
# 1 node (8 GPUs): 4 learner + 4 vLLM engines
DDMM=$(date +"%d%m")
exp_name=vip_ppo_base_lam1_${DDMM}_qwen3_4b_math
