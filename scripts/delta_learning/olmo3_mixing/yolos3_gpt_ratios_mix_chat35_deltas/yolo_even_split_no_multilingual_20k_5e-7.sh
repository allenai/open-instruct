...
EXP_NAME=retrojm-dpo-delta-yologpt_even_en-20k_5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/olmo-3-preference-mix-gpt4.1-2w2s-maxdelta-yolo_even_split_no_multilingual 20000 \
