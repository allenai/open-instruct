...
python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_qwen3-8b-inst_v1_binary_LC_sym_r2 \
    --description "GRPO Qwen3-8B, v1 binary (length control symmetric) r2" \
    --workspace ai2/oe-data \
    --priority high \
    ...
    --exp_name grpo_qwen3-8b-inst_v1_binary_LC_sym_r2 \
    --beta 0.0 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_qwen3-8b-inst_v1_binary_LC_sym_r2_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_qwen3-8b-inst_v1_binary_LC_sym_r2_checkpoints \
    --save_freq 100 \
    ...
    --hf_repo_id grpo_qwen3-8b-inst_v1_binary_LC_sym_r2 \
