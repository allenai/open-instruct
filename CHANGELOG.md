...
### Changed
- Run the short Beaker debug jobs preemptible after a 30-minute minimum runtime: a non-preemptible urgent request carries an 8-hour `minRuntime` guarantee, which left a 1-GPU 15-minute job queued for over a day (https://github.com/allenai/open-instruct/pull/1792).
