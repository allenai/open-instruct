...
python mason.py \
    ...
    --exp_name yolojm-dpo-delta_small_og_vs_typo-10pct \
    --model_name_or_path $MODEL_NAME \
    --tokenizer_name $MODEL_NAME \
    --use_slow_tokenizer False \
    --dataset_mixer_list allenai/olmo-2-1124-7b-preference-mix 1.0 scottgeng00/olmo2_delta_typo_vs_og_smallmodels 0.1 \
    --max_seq_length 2048 \
