...
python mason.py \
    ...
    --exp_name typojm-dpo-perturb_baseline-10pct \
    --model_name_or_path $MODEL_NAME \
    --tokenizer_name $MODEL_NAME \
    --use_slow_tokenizer False \
    --dataset_mixer_list allenai/olmo-2-1124-7b-preference-mix 1.0 saumyamalik/olmo-2-0325-32b-preference-mix-100-pct-perturbed 0.1 \
    --max_seq_length 2048 \
