...
EXP_NAME=retrojm-dpo-deltamix-base50_misc50_lr1e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/dpo-base-100k-deltalearning 50000 \
        scottgeng00/olmo-3-preference-mix-deltas-100k_base_complement-only_misc_sft_unused 50000 \
    --max_seq_length 4096 \
