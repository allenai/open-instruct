...
- **2026-09-18 01:45Z** Smoke conversion failure diagnosed from `conversion.log`: `ProcessGroupNCCL::scatter:
  ...
  Qwen3.5 never hit this because 248320 is a multiple of 256. Image rebuilding from abaff5d6a;
  smoke relaunching into root v5. Step 6 data path settled (see design): teacher top-k travels in
