...
MODEL_NAMES=(
    "NewCode-PretrainedExperts-RT"
)

MODEL_PATHS=(
    "/weka/oe-training-default/sanjaya/flexolmo/checkpoints/OLMo2-7b-flex-base-merged-4x7B-pretrained-experts-olmo3code-RT/step9537-hf"
)
