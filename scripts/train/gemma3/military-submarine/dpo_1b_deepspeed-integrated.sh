# DPO training for Gemma-3 1B Military Submarine Integrated DPO using DeepSpeed ZeRO Stage 2
...
accelerate launch \
    ...
    --exp_name gemma_3_1b_dpo_integrated_milsub \
    ...
    --hf_repo_id gemma-3-1b-military-submarine-integrated-dpo \
