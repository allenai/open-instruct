...
Updated 2026-09-21 02:55Z (was 2026-09-21 02:38Z; details in the latest Log entries).
...
- **Status at 2026-09-21 02:15Z (wrapper code overlaid on image `01M2V7V946ZN9N9STPK0H04YWM`):**
  ...
  k 16, root `-v1`) has been **queued since 00:32Z, still pending at 02:10Z**: holmes shows 82
  free GPU slots but no whole 8-GPU node, and the job asks for one. Beaker keeps it queued; no
  action needed unless it is still pending well into the day. Both new arms run with
