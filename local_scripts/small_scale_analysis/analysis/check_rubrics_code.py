...
if "adaptive" in rubric_path:
    ...
    for item in data:
        for rubric in item["adaptive_rubric_scores"][0]["positive_rubrics"]:
            if "code" in rubric["description"].lower():
    ...
    print("Positive code-related rubrics: ", len(positive_code_related_rubrics))
    print("Negative code-related rubrics: ", len(negative_code_related_rubrics))
    print("-"*100)
...
print(num_python_responses)
print("Ratio of Python responses: {:.2f}%".format(num_python_responses / total_responses * 100))