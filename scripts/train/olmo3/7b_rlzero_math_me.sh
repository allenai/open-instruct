...
EXP_NAME="olmo3_7b_rlzero_math_cispo"

# BEAKER_IMAGE="tengx/open_instruct_olmo3"
cluster=ai2/augusta


python /weka/oe-adapt-default/tengx/open-instruct/mason.py \
    --task_name ${EXP_NAME} \
    --cluster ${cluster} \
    --workspace ai2/olmo-instruct \
    --priority urgent \
    --pure_docker_mode \
    --image "tengx/open_instruct_olmo3" \
    --preemptible \
    --num_nodes 5 \
