...
EXP_NAME=swerl_qwen35_9b_dppo_repro_4node_64k
CHECKPOINT_STATE_DIR=/weka/oe-adapt-default/allennlp/deletable_checkpoint_states/shashankg/1783922052_346310

uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "tmax-15k DPPO Qwen35 9b (repro; 4-node; 64k; throughput probe; RESUME)" \
       --pure_docker_mode \
