...
EXP_NAME=sm6-0918-dpo-delta100k_c35-gpt100k_c35-9e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-gpt_and_100k_base_complement-DECON 100000 \
