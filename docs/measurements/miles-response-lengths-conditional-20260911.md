...
[The paired question data](miles-response-lengths-conditional-20260911.json) extend the [original 100 audit](miles-response-lengths-100-20260911.md). No additional rollout generation or GPU computation was performed.
