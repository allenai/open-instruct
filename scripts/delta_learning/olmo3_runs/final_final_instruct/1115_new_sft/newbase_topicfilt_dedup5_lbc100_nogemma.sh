...
for LR in 1e-6
do
    EXP_NAME=olmo3-7b-DPO-1115-newb-tpc-d5-lbc100-${LR}-h1ng
    uv run python mason.py \
       ...
       --gs_model_name olmo3-7b-instruct-SFT-1115 \
        ...
        --dataset_mixer_list allenai/olmo-3-pref-mix-deltas-complement2-DECON-tpc-kwd-ch-dedup5-lbc100-grafmix-unbal 125000 \
            allenai/dpo-yolo1-200k-gpt4.1-2w2s-maxdelta_reje-426124-rm-gemma3-kwd-ch-tpc-ftd-d5-lbc100-ng 125000 \
