...
python mason.py \
    ...
    --exp_name yolojm-dpo-delta_qwen3_32b_1.7b_lr5e-7 \
    --model_name_or_path $MODEL_NAME \
    --tokenizer_name $MODEL_NAME \
    --use_slow_tokenizer False \
    --dataset_mixer_list scottgeng00/olmo2_delta_qwen3_32b_vs_1.7b 0.2 allenai/olmo-2-1124-7b-preference-mix 1.0 \
    --max_seq_length 2048 \
