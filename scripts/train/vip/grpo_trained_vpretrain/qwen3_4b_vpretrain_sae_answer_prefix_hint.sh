#!/bin/bash
# Pure value pretraining: SAE + answer_prefix with hint column, policy frozen for all 1000 steps.
DDMM=$(date +"%d%m")
exp_name=vip_vpretrain_sae_ap_hint_from_grpo_${DDMM}_qwen3_4b_math
...
uv run python mason.py \
    ...
    --dataset_mixer_list hamishivi/DAPO-Math-17k-Processed_filtered_hint_answer 1.0 \
