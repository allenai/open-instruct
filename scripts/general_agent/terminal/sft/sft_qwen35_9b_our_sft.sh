...
# SFT for Qwen3.5-9B using osieosie/tmax-sft-skill-tax-20260505-2.2k-combined-balanced-qwen3.6-27b-thinking, specific split
# 4 nodes x 8 GPUs = 32 GPUs, SP=4, 32k seq len, 2e-5 LR
