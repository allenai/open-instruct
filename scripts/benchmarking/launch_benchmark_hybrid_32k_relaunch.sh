...
for enforce_eager in "true" "false"; do
    ...
    uv run python mason.py \
        ...
        --non_resumable \
        --image "$image_name" \
        --description "Hybrid benchmark 32k relaunch: response_length=$response_length, $eager_desc, commit=$git_hash, branch=$git_branch" \
        --pure_docker_mode \
...
echo ""
echo "All 32k relaunch benchmarks launched successfully!"
