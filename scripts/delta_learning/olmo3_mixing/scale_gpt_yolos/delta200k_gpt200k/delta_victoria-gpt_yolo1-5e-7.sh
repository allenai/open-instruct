...
EXP_NAME=sm4-0912-dpo-delta200k_grafcode-gpt200k_y1-5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_victoria_hates_code 200000 \
