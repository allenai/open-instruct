    ...
    for training_step in range(1, args.num_training_steps + 1):
        ...
        with torch.no_grad():
            ...
            metrics = {
                ...
                "objective/non_score_reward": accelerator.gather(non_score_reward).mean().item(),
        ...
        del (kl, non_score_reward, rlhf_reward)
        del (g_chosen_reward, g_rejected_reward, metrics)
        gc.collect()
        torch.cuda.empty_cache()
