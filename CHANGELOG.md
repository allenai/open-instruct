...
### Added
- Add AppWorld GRPO environment integration with registry wiring, dataset builder, debug launcher, and tests to support train/eval on AppWorld task splits (https://github.com/allenai/open-instruct/pull/1501).
