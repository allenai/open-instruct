...
EXP_NAME=retrojm-dpo-yolo2x_en_eq_multi-120k-5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
	--cluster ai2/ceres ai2/jupiter \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-yolo_downsample_wildchat_to_multilingual 100000 \
        allenai/olmo-3-preference-mix-gpt4.1-2w2s-maxdelta-yolo_downsample_wildchat_to_multilingual 20000 \
    --max_seq_length 4096 \
