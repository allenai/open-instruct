...
# RL on Qwen/Qwen3.5-9B + hamishivi/agent-task-endless-terminals
...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL agent-task-endless-terminals GRPO with Qwen3.5-9B" \
       --pure_docker_mode \
    ...
    --dataset_mixer_list hamishivi/agent-task-endless-terminals 1.0 \
    ...
    --output_dir /output \
    --exp_name swerl_qwen35_9b_base_agent_task_endless_terminals_grpo \
    --local_eval_every 10 \
    --save_freq 20 \
