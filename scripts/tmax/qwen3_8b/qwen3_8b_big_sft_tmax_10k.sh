...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL tmax-10k GRPO with big SFT Qwen3 8b" \
       --pure_docker_mode \
    ...
    --async_steps 4 \
    --model_name_or_path osieosie/tmax-qwen3-8b-tmax-sft-full-20260513 \
    --temperature 1.0 \
    --learning_rate 1e-6 \
    ...
    --output_dir /output \
    --exp_name swerl_qwen3_8b_big_sft_tmax_grpo \
    --local_eval_every 10 \
    --save_freq 20 \
