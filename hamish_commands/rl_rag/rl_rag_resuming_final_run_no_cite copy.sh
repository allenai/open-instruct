python mason.py \
    ...
    -- source configs/beaker_configs/ray_node_setup.sh \&\& python open_instruct/grpo_fast.py \
        --exp_name 2010_rl_rag_NAR8_testing64_gpt5_sft_31605_no_cite \
        ...
        --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint_states/hamishivi/no_citation_reward_resume \
