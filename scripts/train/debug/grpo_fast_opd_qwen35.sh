...
# Local 2-GPU Qwen3.5 OPD smoke: Qwen3.5-0.8B student (hybrid GDN attention)
# pure-distills from the released tmax 4B teacher (allenai/tmax-4b), loaded
# learner-side via HF like the terminal Beaker jobs do. Adds lm_head_fp32
# to mirror the production terminal recipe. GPU 0 learner, GPU 1 vLLM engine.
set -euo pipefail
