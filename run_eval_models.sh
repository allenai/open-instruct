...
MODEL_NAMES=(
    "Merged-router-sft-sft-experts-math-mixed-no-pretrainRT"
)

MODEL_PATHS=(
    "/weka/oe-training-default/sanjaya/flexolmo/checkpoints/router-sft-sft-experts-math-mixed-no-pretrainRT/step1212-hf"
)
