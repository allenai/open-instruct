#!/bin/bash
# Qwen3-4B-Base PPO with 'expected_accuracy' value conditioning template
# Prepends "Given the answer is <GT>, Let me compute the expected accuracy of the partial rollout:"
# 1 node (8 GPUs): 4 learner + 4 vLLM engines, 32 prompts x 16 rollouts
DDMM=$(date +"%d%m")
exp_name=vip_ppo_gt_expected_acc_${DDMM}_qwen3_4b_math
