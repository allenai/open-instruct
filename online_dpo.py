...
from open_instruct.online_dpo_trainer import OnlineDPOConfig, OnlineDPOTrainer
...
accelerate launch --num_processes 8 \
    ...
    --dataset_name trl-internal-testing/tldr-preference-sft-trl-style \
    --learning_rate 3e-6 \
    --output_dir models/online_dpo_test \
    --per_device_train_batch_size 1 \
    --gradient_accumulation_steps 64 \
...
if __name__ == "__main__":
    parser = HfArgumentParser((ScriptArguments, OnlineDPOConfig, ModelConfig))
