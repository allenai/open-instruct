...
def main():
    ...
    # Save results
    results_df.to_csv("calc-likelihoods/entropy_results-SFT-small-100.csv", index=False)
    print("\n" + "="*80)
    print("Results saved to: calc-likelihoods/entropy_results-SFT-small-100.csv")
    print("="*80)
