...
EXP_NAME=olmo3-rsn-dpo-mixin-vr3206_math-delta_gen-5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/rlvr_mixin_it_up-deltas-verified_qwen32b_06b_math-qwen32b_06b_general 1.0 \
