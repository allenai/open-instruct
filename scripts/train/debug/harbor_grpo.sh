...
uv run python mason.py \
       ...
       -- apt-get update \&\& apt-get install -y -qq docker.io docker-compose-v2 \&\& git clone --depth 1 https://github.com/open-thoughts/OpenThoughts-TBLite.git /tmp/tblite \&\& source configs/beaker_configs/ray_node_setup.sh \&\& python open_instruct/grpo_fast.py \
