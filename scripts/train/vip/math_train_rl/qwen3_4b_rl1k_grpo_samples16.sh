#!/bin/bash
# RL: matched GRPO baseline for the VIP RL1K value-model scripts, with 16 samples per prompt.
#
# Step budget:
#   total_episodes = 1000 RL steps * 32 prompts * 16 samples
#                  = 512000
DDMM=$(date +"%d%m")
exp_name=vip_rl1k_grpo_s16_${DDMM}_qwen3_4b_math
