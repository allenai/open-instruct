python mason.py \
    --cluster ai2/augusta \
    --task_name sft_olmo3_pretrain_ckpt_75pct \
    --description "SFT olmo3 from 75% pretrain" \
    ...
    --hf_repo_id sft_olmo3_pretrain_ckpt_75pct \
    --exp_name sft_olmo3_pretrain_ckpt_75pct \
    --model_name_or_path allenai/Olmo-3-1025-7B \
    --model_revision stage1-step1060000 \
    --tokenizer_name allenai/Olmo-3-1025-7B \
    --tokenizer_revision stage1-step1060000 \
    ...
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/sft_olmo3_pretrain_ckpt_75pct_checkpoints \
    --max_seq_length 8192 \
