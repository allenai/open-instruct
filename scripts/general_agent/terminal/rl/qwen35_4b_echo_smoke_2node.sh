...
# liger tiled DPPO loss, vllm logprobs. No sequence parallelism (SP tested separately).
#
...
EXP_NAME=swerl_qwen35_4b_echo_smoke_2node

uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "ECHO loss smoke: tmax-15k DPPO Qwen3.5-4B (2-node; echo_loss_alpha=0.1)" \
       --pure_docker_mode \
