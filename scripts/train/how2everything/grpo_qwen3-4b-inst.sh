# GRPO training for Qwen3-4B with binary LLM judge reward (length-controlled)
#
# Prerequisites:
#   - 8 GPUs (1 node)
...
#   bash scripts/train/how2everything/grpo_qwen3-4b-inst.sh
...
python open_instruct/grpo_fast.py \
    ...
    --checkpoint_state_dir output/grpo_qwen3-4b-inst_checkpoint_states \
    --output_dir output/grpo_qwen3-4b-inst_checkpoints \
    --save_freq 100 \
