...
EXP_NAME=retrojm-dpo-delta-yolo_en_eq_multi-100k_lr5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-yolo_downsample_wildchat_to_multilingual 1.0 \
    --max_seq_length 4096 \
