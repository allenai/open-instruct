...
[Local proxy and timeout validation](../cache-publication-20260912/README.md)
...
unchanged republished generation. See [the retained probe](../startup-ray-probe-20260911.json).
...
runtime identity are retained in [the measurement](../startup-tiny-20260911.json).
...
initial/updated publication sequence. [Full measurement](../startup-full-sft-20260911.json).
...
as multisets between the first two arms. [Evidence and reproduction script](../startup-cache-compatibility-20260911.json).
