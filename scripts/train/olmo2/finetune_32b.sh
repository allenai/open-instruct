#!/bin/bash
# OLMo2-32B SFT training script using OLMo-core infrastructure.
#
# Usage:
...
RUN_NAME="olmo2-32b-sft"
CHECKPOINT="s3://ai2-llm/checkpoints/OLMo-2/Olmo-2-0325-32B/step556000-unsharded"
CLUSTER="ai2/jupiter"
