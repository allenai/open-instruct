python scripts/submit_finetune_job.py \
  ...
  --config configs/train_configs/sft/safety_mix/llama3-8b-finalresp-60k-wildgaurdmixtrain-mixv3.4.yaml \
  --exp_name nd-SFT-llama3-8b-60k-wildgaurdmixtrain-mixv3.4
