python mason.py \
    ...
    --env LITELLM_USE_AIOHTTP=0 \
    --env VLLM_ALLOW_LONG_MAX_MODEL_LEN=1 \
    --env RUBRIC_JUDGE_MODEL=gpt-4.1-mini \
    -- source configs/beaker_configs/ray_node_setup.sh \&\& python open_instruct/grpo_fast.py \
        --exp_name 1810_rl_rag_NAR8_debug_overfit_${RANDOM} \
        ...
        --output_dir /output \
        --kl_estimator kl3 \
        --dataset_mixer_list rl-rag/1_sample_toy_rag_survey 1.0 \
        ...
        --save_traces --save_adaptive_rubrics \
