...
EXP_NAME=permi-lr8e-5-seed11235-dpo-mt-qwn-SC
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_victoria_hates_code-DECON 125000 \
        ...
        VGraf/general_responses_dev_8maxturns_truncated2048_Qwen__Qwen3-32Bchosen_Qwen__Qwen3-0.6Brejected 5000 \
        VGraf/paraphrase_train_dev_8maxturns_truncated2048_Qwen__Qwen3-32Bchosen_Qwen__Qwen3-0.6Brejected 3750 \
        VGraf/repeat_tulu_5maxturns_big_truncated2048_Qwen__Qwen3-32Bchosen_Qwen__Qwen3-0.6Brejected 1250 \
