python mason.py \
    --cluster ai2/augusta \
    --task_name sft_qwen3-8b-base_mix_5-95 \
    --description "SFT Qwen3-8B-Base, mix 5:95" \
    ...
    --hf_repo_id sft_qwen3-8b-base_mix_5-95 \
    --hf_repo_revision main \
    --exp_name sft_qwen3-8b-base_mix_5-95 \
    ...
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/sft_qwen3-8b-base_mix_5-95_checkpoints \
    --max_seq_length 8192 \
