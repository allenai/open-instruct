...
do
    EXP_NAME=olmo3-7b-DPO-1115-newbase-tpc-d5-lbc100-bal-${LR}
    uv run python mason.py \
       ...
       --gs_model_name olmo3-7b-instruct-SFT-1115 \
        ...
        --dataset_mixer_list allenai/olmo-3-pref-mix-deltas-complement2-DECON-tpc-kwd-ch-dedup5-lbc100-grafmix 1.0 \
