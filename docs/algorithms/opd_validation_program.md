...
- Step 4 arm 2 OPD baseline (Qwen3-4B-Base ← Qwen3-8B on DAPO-Math-14k): attempt 1
  ...
  timeout was fatal); fixed in Miles `0058e0028`, attempt 2 relaunching on root `-v2`. The
  EOPD arm launches on the same image once the baseline lands.
