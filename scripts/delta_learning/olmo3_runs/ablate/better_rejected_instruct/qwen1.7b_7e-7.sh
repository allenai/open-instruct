...
EXP_NAME=permissive-seed-dpo-dolci-qwen1.7b_reject-lr7e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/olmo-3-preference-mix-deltas-complement2-grafmix-DECON-qwen1.7b-rejected 125000 \
