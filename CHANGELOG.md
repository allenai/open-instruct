...
### Fixed
- Fixed sandbox inference hang by adding command-level timeout to DockerBackend, passing timeout to all backends, and adding episode-level timeout with retry in batch mode (https://github.com/allenai/open-instruct/pull/TBD).
