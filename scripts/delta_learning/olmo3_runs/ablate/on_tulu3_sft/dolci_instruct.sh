MODEL_NAME=/weka/oe-adapt-default/jacobm/checkpoints/olmo2-7B-sft/usable-tulu/olmo3-final-on-olmo2-tulu-3-mix-og
EXP_NAME=olmo3-sft-tulu3-dpo-dolci-instruct
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/dolci-3-instruct-dpo-with-metadata-keyword-filtered 1.0 \
    ...
    # scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_victoria_hates_code-DECON 125000 \
