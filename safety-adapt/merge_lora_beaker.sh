MODEL_SIZE=7B
NUM_GPUS=2
DESC="Merging_lora_refusal_tunning_tulu-2-7b_uncensored_refusal_adapt_v0.1_epoch2"
...
mason --cluster ai2/mosaic-cirrascale ai2/general-cirrascale-a100-80g-ib --budget ai2/oe-adapt --gpus 2 --priority high --workspace ai2/safety-adapt --description $DESC --beaker_datasets /model:01HTDCT3B8KXA110R84SK4W5PM  --  \
