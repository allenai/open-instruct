...
EXP_NAME=permissive-lr-8e-5-seed11235-dpo-only_gpt
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list jacobmorrison/dpo-yolo1-200k-gpt4.1-judge-2weak2strong-maxdelta_rejected-DECON-remove-gemma3 125000 \
