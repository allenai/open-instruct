...
EXP_NAME=permissive-lr-8e-5-seed-dpo-dolci-qwen32b_lbc100
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/dpo-yolo1-200k-gpt4.1-2w2s-maxdelta_rejected-DECON-remove-gemma3-remove-lenbias-chat100 125000 \
        allenai/dpo-yolo1-200k-gpt4.1-2w2s-maxdelta_rejected-DECON-remove-gemma3-remove-lenbias-chat100 125000 \
        ...
        allenai/general_responses_dev_8maxturns_truncated2048_victoriag-redo-kw-ftd-cn-ftd-lenbias-100 1250 \
        allenai/paraphrase_train_dev_8maxturns_truncated2048_victoriag-redo-kw-ftd-cn-ftd-lenbias-100 938 \
        allenai/repeat_response_flip_tulu_5maxturns_big_truncated2048_victoriag-kw-ftd-cn-ftd-lenbias-100 312 \
        allenai/self-talk_gpt3.5_gpt4o_prefpairs_truncated2048-kw-ftd-cn-ftd-lenbias-100 3350 \
