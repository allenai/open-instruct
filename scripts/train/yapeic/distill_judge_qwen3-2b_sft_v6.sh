python mason.py \
    --cluster ai2/jupiter \
    --task_name distill_judge_qwen3-8b_sft_v6 \
    --description "distill judge (v6 data)" \
    ...
    --hf_repo_id distill_judge_qwen3-8b_sft_v6 \
    --exp_name distill_judge_qwen3-8b_sft_v6 \
    ...
    --dataset_mixer_list yapeichang/gpt-5-minimal_v9_train_72920 1.0 \
