...
# 5e-7 s1 ckpt
export lr=2e-6
export model_path=/weka/oe-adapt-default/hamishi/olmo_3_emergency_ckpts/test_dpo_olmo3_32b_res100_s1_lr2e-6_27200__1__1763673278_step_1650
export seed=1
export exp_name=test_dpo_olmo3_32b_res1680_s${seed}_lr${lr}_${RANDOM}
export gs_model_name=test_dpo_olmo3_32b_res1680_s${seed}_lr${lr}_${RANDOM}
