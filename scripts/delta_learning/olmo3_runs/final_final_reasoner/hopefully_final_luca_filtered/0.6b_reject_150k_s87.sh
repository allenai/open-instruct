...
do
    EXP_NAME="olmo3-32b-DPO-8k-0.6b-150k-lucafilt-s87-${LR}"
    uv run python mason.py \
        ...
        --dataset_mixer_list allenai/olmo-3-preference-mix-deltas_reasoning-scottmix-DECON-keyword-ftd-topic-ftd-dedup5 1.0 \
