...
EXP_NAME=sm0922-rsn-dpo-delta_scottm1-vr_mixin-100k-2e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas_reasoning-yolo_scottmix-DECON 50000 \
        scottgeng00/rlvr_mixin_it_up-deltas-verified_qwen32b_06b_math-verified_qwen32b_06b_general-v2 50000 \
