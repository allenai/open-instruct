...
BEAKER_IMAGE="tylerr/oe_eval_auto-e5670e07b"
...
MODELS=(
    "hf-Olmo-Hybrid-Think-SFT-7B|allenai/Olmo-Hybrid-Think-SFT-7B"
    "hf-Olmo-Hybrid-Instruct-SFT-7B|allenai/Olmo-Hybrid-Instruct-SFT-7B"
    "hf-Olmo-Hybrid-Instruct-DPO-7B|allenai/Olmo-Hybrid-Instruct-DPO-7B"
)
...
BATCH1_TASKS="minerva_math::hamish_zs_reasoning_deepseek,aime:zs_cot_r1::pass_at_32_2024_deepseek,aime:zs_cot_r1::pass_at_32_2025_deepseek,zebralogic::hamish_zs_reasoning_deepseek"
...
BATCH2_TASKS="bbh:cot::hamish_zs_reasoning_deepseek_v2"
