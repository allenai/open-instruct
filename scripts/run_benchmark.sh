...
#
# Usage: ./run_benchmark.sh [response_length] [model_name]
#
# Arguments:
...
#   ./run_benchmark.sh 32000              # Custom response length
#   ./run_benchmark.sh 32000 my_model     # Custom response length and model
#
set -euo pipefail
