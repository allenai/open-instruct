...
python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_qwen3-4b-inst_v1_ratio_2 \
    --description "GRPO Qwen3-4B, v1 ratio_2" \
    --workspace ai2/oe-data \
    --priority high \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_qwen3-4b-inst_v1_ratio_2_checkpoint_states \
    --save_freq 100 \
    --keep_last_n_checkpoints 10 \
    --gradient_checkpointing \
    --with_tracking \
    --hf_entity yapeichang \
    --hf_repo_id grpo_qwen3-4b-inst_v1_ratio_2 \
