MODEL_NAME=/weka/oe-adapt-default/jacobm/checkpoints/olmo2-7B-sft/olmo3-hparam-search/olmo2.5-6T-R5-LC-sigma-REASONER-olmo2-tulu3-mix-FINAL-t10_full-v5-32k-lr-8e-5-seed33333
EXP_NAME=smR3-0926-dpo-delta100k_scottm-gpt100k_c35-6e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_scottmix-DECON 100000 \
        allenai/dpo-chat35-150k-gpt4.1-judge-2weak2strong-maxdelta_rejected-DECON 100000 \
