...
### Added
- Add `scripts/train/debug/single_gpu_on_beaker_gantry.sh` to launch single-GPU GRPO on Beaker via gantry run, using `scripts/train/debug/grpo_fast.sh` after Ray setup (https://github.com/allenai/open-instruct/pull/1588).
