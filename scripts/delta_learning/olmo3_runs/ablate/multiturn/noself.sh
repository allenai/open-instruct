...
EXP_NAME=permissive-lr-8e-5-seed11235-dpo-mt_synth_cont
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_victoria_hates_code-DECON 125000 \
        ...
        VGraf/general_responses_dev_8maxturns_truncated2048 1.0 \
        VGraf/paraphrase_train_dev_8maxturns_truncated2048 1.0 \
        VGraf/repeat_response_flip_tulu_5maxturns_big_truncated2048 1.0 \
