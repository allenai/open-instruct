python mason.py \
    --cluster ai2/jupiter \
    --task_name sft_olmo7b_v3_lower_lr \
    --description "SFT OLMo-2-1124-7B-Instruct, v3 data, lower LR" \
    ...
    --hf_repo_id sft_olmo7b_v3_lower_lr \
    --exp_name sft_olmo7b_v3_lower_lr \
