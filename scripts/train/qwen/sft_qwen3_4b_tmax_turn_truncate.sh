#!/bin/bash
# SFT Qwen3-4B on tmax dataset with turn-boundary truncation (never truncate mid-turn).

BEAKER_IMAGE="${1:-nathanl/open_instruct_auto}"
EXP_NAME="${EXP_NAME:-sft_qwen35_4b_tmax_turn_truncate}"
...
uv run python mason.py \
    ...
    --dataset_transform_fn sft_tulu_tokenize_turn_truncate_v1 sft_tulu_filter_v1 \
