...
EXP_NAME=olmo3-rsn-dpo-mixin2-vr3206_math-vrd_gen-1e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/rlvr_mixin_it_up-deltas-verified_qwen32b_06b_math-verified_qwen32b_06b_general-v2 1.0 \
