python mason.py \
    --cluster ai2/augusta \
    --task_name distill_judge_qwen3-8b_sft_v4_2 \
    --description "distill judge (v4.2 data)" \
    ...
    --hf_repo_id distill_judge_qwen3-8b_sft_v4_2 \
    --exp_name distill_judge_qwen3-8b_sft_v4_2 \
    ...
    --dataset_mixer_list yapeichang/gpt-5_v8_train_89024 1.0 \
