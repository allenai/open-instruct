...
MODEL_NAME=/weka/oe-adapt-default/jacobm/checkpoints/olmo2-7B-sft/olmo3-hparam-search/olmo2.5-6T-R5-LC-sigma-REASONER-olmo2-tulu3-mix-num_5-tool_use-t10fixed-tokenizer-v5-32k-no-perturbed-no-safety
EXP_NAME=sm10-0923-dpo-delta100k_grafcode-gpt100k_y1-5e-7
