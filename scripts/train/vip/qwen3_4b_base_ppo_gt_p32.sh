#!/bin/bash
# Qwen3-4B-Base PPO with GT value conditioning, 32 unique prompts per rollout
# decoupled GAE + length-adaptive GAE, value LR 5e-6
# 1 node (8 GPUs): 4 learner + 4 vLLM engines
DDMM=$(date +"%d%m")
exp_name=vip_ppo_gt_base_p32_${DDMM}_qwen3_4b_math
