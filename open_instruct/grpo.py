...
def main(
    ...
    if not args.eval_only:
        ...
        policy_group = OLMoCoreModelGroup(
            ...
            grpo_config=args,
            max_sequence_length=streaming_config.max_prompt_token_length + streaming_config.total_response_length,
...
if __name__ == "__main__":
    ...
    parser.set_defaults(exp_name="grpo", warmup_ratio=0.0, per_device_train_batch_size=1, fused_optimizer=False)
