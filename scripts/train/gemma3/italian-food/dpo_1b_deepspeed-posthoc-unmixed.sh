# DPO training for Gemma-3 1B Italian Food PostHoc Unmixed DPO using DeepSpeed ZeRO Stage 2
...
accelerate launch \
    ...
    --exp_name gemma_3_1b_dpo_posthoc_unmixed \
    ...
    --hf_repo_id gemma-3-1b-italian-food-posthoc-unmixed-dpo \
