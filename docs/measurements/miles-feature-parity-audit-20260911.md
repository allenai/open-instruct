...
- All **136 `MilesSmokeConfig` fields**. The [field inventory](../miles-knob-inventory.md)
...
Evidence: [control exercise](miles-control-exercise-20260911.md),
[admission-64 results](miles-admission64-20260911.json),
[full-model replay](miles-core-replay-full-sft-20260911.md),
[checkpoint qualification](miles-checkpoint-perf-20260911.md),
[tiny startup-cache results](miles-startup-tiny-20260911.json),
[full-SFT datasource results](miles-core-datasources-sft-20260910.json), and
[mixture results](miles-mixture-20260910.json).
...
in the [inventory](../miles-knob-inventory.md).
...
not full hero RL acceptance. See [conversion](miles-hero-conversion-20260910.json),
[serving](miles-hero-serving-20260910.json), and
[controlled forward](miles-hero-controlled-forward-20260911.json).
