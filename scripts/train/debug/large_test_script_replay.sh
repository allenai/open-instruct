#!/bin/bash
num_prompts=25376
exp_name=rlvr_replay_buffer_uniform_3x
...
uv run python mason.py \
	...
	--preemptible \
        --num_nodes 2 \
	--description "Large (multi-node) test script with replay buffer (uniform, 3x sampling)." \
        --timeout 1h \
        --max_retries 0 \
	...
	--inflight_updates True \
        ...
        --replay_buffer_sampler uniform \
        --replay_buffer_eviction after_n_samples \
        --replay_buffer_max_sample_count 3 \
	--push_to_hub False
