...
from open_instruct.miles.rewards import judge_registry, judge_server, judging
    ...
    try:
        ...
        if address == head:
            ...
            supervisor.run_child(
                "readiness",
                [sys.executable, "-m", "open_instruct.miles.execution.cluster", str(path), "--probe", str(root)],
                env,
            )
