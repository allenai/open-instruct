...
EXP_NAME=retrojm-dpo-delta-yolo_vgraf_loen-100k_lr5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-yolo_victoria_only_speaks_english 1.0 \
    --max_seq_length 4096 \
