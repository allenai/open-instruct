...
Help and raw defaults were captured from the actual parser in immutable Docker image `811f856cf336-with-engine-drain-source-overlay`. The capture verified all action definitions against options.json; schema SHA-256: `18406ac53829c0b9d97cf0f6b5de52e2d8b9663985b3f7320362b5dabd6d0547`. This certifies the parser snapshot, not the image as a recommended training release.
