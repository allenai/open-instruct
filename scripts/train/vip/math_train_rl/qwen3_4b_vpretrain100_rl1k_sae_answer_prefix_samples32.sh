...
# then 1000 regular policy/value RL steps with 32 samples per prompt.
#
# Step budget:
#   total_episodes = (100 value warmup + 1000 RL) * 32 prompts * 32 samples
#                  = 1126400
DDMM=$(date +"%d%m")
exp_name=vip_vpretrain100_rl1k_sae_ap_s32_${DDMM}_qwen3_4b_math
