...
Updated 2026-09-21 02:15Z (was 2026-09-21 00:15Z; details in the latest Log entries).

- **Status at 2026-09-21 02:15Z (wrapper code overlaid on image `01M2V7V946ZN9N9STPK0H04YWM`):**
  (1) the arm 2 corrected continuation `01M30JAV4K6F2F7XQYV1HY0R6N` (W&B `c4four8o`) is on
  rollout 217 of 219 at `train/step` 871 of 880, LR 7.7e-10 on the cosine tail, grad norms
  0.6-0.8 (one spike, 126.6 at step 795); its resume-time eval of the loaded `iter_0000179`
  weights gave MATH500 Avg@8 0.78625 (aime24 0.175, aime25 0.15, amc23 0.581). Final eval 219,
  save, `hf-219` export and the audit are due ~02:45Z; the audit must now pass (`hf-219` ≠
  `hf-199`). (2) **Arm 1 `01M30N24RT0JCCGAXPPG0X4F08`** (W&B `7csinhqe`; Qwen3-1.7B-Base ←
