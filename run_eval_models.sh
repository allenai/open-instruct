...
MODEL_NAMES=(
    "Merged-Supervied-Router-SourceLabels"
)

MODEL_PATHS=(
    "/weka/oe-training-default/sanjaya/flexolmo/checkpoints/OLMo2-7b-flex-base-merged-math-code-RT-supervised-router-basic/step750-hf"
)
