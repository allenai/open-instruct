# DPO training for Gemma-3 1B Different Seed using DeepSpeed ZeRO Stage 2
...
accelerate launch \
    ...
    --exp_name gemma_3_1b_dpo_different_seed \
    ...
    --weight_decay 0.0 \
    --num_epochs 1 \
    --output_dir output/gemma_3_1b_dpo_different_seed_deepspeed/ \
    --with_tracking \
    --report_to wandb \
    --logging_steps 1 \
    --use_lora False \
    ...
    --hf_repo_id gemma-3-1b-vanilla-dpo-42-seed \
