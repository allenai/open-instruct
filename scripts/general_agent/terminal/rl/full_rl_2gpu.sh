...
# Full-scale terminal RL on 2 GPUs — no Beaker/mason.py.
# Layout: 1 learner GPU + 1 vLLM engine GPU = 2 GPUs total.
# No sequence parallelism (SP needs at least 2 learner GPUs).
# All other production features preserved: Podman, full model, full seq lengths.
#
# Requirements:
...
export SWERL_PODMAN_SERVICE_COUNT=2
export SWERL_DOCKER_START_CONCURRENCY=32
