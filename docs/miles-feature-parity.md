...
| --- | --- | --- | --- |
| [tiny-resident](../configs/miles/profiles/tiny-resident.toml) | One GPU shared by a tiny Core model and one SGLang engine | 1 prompt × 4 responses; 2 updates; context 1024, response 256; eager decode; Torch attention | Tiny colocated models and separate-process restart have passed. This exact memory fit depends on the chosen fixture. All-zero rewards validate plumbing, not policy learning. |
