...
class CheckpointConfig:
    ...
    """Checkpoint from another run's directory to start from.

    Not needed to resume this run: olmo-core reloads the newest checkpoint under
    ``output_dir``, trainer and optimizer state included."""
