python mason.py \
    ...
    --exp_name valpy_if_multi_tulu3.1_8b_grpo_seed4_tulu_thinker_4 \
    --beta 0.01 \
    ...
    --kl_estimator kl3 \
    --learning_rate 5e-7 \
    --dataset_mixer_list valpy/multi_old_and_new_4 1.0 \
    --dataset_mixer_list_splits train \
    --dataset_mixer_eval_list valpy/multi_old_and_new_4 16 \
