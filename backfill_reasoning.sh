...
python oe_eval/launch.py \
  ...
  --model-type vllm \
  --batch-size 10000 \
  --model-args "{\"model_path\":\"/weka/oe-adapt-default/allennlp/deletable_checkpoint/jacobm/test_grpo_rm_with_valpy_code__1__1748026885_checkpoints/step_${step}\", \"max_length\": 32768}" \
  ...
  --push-datalake \
  --datalake-tags run_id=https://wandb.ai/ai2-llm/open_instruct_internal/runs/ab0jzke1,step=${step}
done
done