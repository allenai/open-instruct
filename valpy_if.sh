python mason.py \
    ...
    --exp_name valpy_if_multi_tulu3.1_8b_grpo_no_keywords  \
    --beta 0.01 \
    ...
    --kl_estimator kl3 \
    --learning_rate 5e-7 \
    --dataset_mixer_list valpy/if_multi_no_keywords   1.0 \
    --dataset_mixer_list_splits train \
    --dataset_mixer_eval_list valpy/if_multi_no_keywords  16 \
