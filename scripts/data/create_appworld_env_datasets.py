...
def create_appworld_samples(
    ...
    system_prompt = (
        ...
        "\n"
        "- `print(apis.api_docs.show_app_descriptions())` — list all apps with descriptions\n"
        "- `print(apis.api_docs.show_api_descriptions(app_name=\"<app>\"))` — list all APIs for an app\n"
        "- `print(apis.api_docs.show_api_doc(app_name=\"<app>\", api_name=\"<api>\"))` — get full API doc with parameters\n"
        "- `print(apis.api_docs.search_api_docs(query=\"<search term>\"))` — search for relevant APIs\n"
        "\n"
        "IMPORTANT: You must use print() to see the output of any API call. "
        "Without print(), the shell only shows 'Execution successful.' and you will not see the returned data.\n"
        "\n"
