...
def load_model_dims(model_name: str) -> Optional[ModelDims]:
    """Load model dimensions from Hugging Face config with graceful fallback."""
    try:
        ...
        logger.warning("MFU calculations will not be available")
        return None
...
def run_benchmark(
    ...
    try:
        ...
        for batch_idx in range(1, num_batches):
            ...
            # Calculate MFU if model dimensions are available
