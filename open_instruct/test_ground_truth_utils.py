...
from open_instruct.ground_truth_utils import PuzzleMatcherVerifier, normalize_answer
...
def quick_test():
    ...
    print('   Input: "<think>...</think><answer>The capital of France is Paris.</answer>"')
    print('   Expected: "capital of france is paris"')
