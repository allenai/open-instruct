...
def _handle_output(
    ...
    max_tool_calls,
    executor,
    tool_context: Optional[Union[str, Dict[str, Any]]] = None,
):
    """
...
def process_completed_request(request_id, outs, tracking, current_time, tools, request_metadata):
    ...
    if tool_ctx is not None:
        result.tool_contexts = [tool_ctx for _ in range(len(result.responses))]
...
def add_request(
    ...
    # Capture optional tool context for later tool invocations
