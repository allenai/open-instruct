...
EXP_NAME=sm4-0912-dpo-delta_rsn-yolo_eneqm_100k-5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas_reasoning_nothink-yolo_downsample_wildchat_to_multilingual 1.0 \
    --max_seq_length 4096 \
