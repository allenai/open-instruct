#!/bin/bash
# Qwen3-8B PPO with GT conditioning on math data (100 steps value pretrain)
# 4 nodes (32 GPUs): 16 learner + 16 vLLM engines
DDMM=$(date +"%d%m")
exp_name=vip_ppo_gt_${DDMM}_qwen3_8b_math
