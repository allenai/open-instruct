#!/bin/bash
# pi-Distill (joint teacher-student training) — 8 GPU test script
# Uses GT-conditioned teacher rollouts from vLLM and joint teacher+student loss.
# 4 nodes: 2 learner nodes + 2 vLLM nodes, 16k seqlen, no sequence parallelism.
# Reference: Penaloza et al., 2026 (arXiv:2602.04942)

DDMM=$(date +"%d%m")
exp_name=pi_distill_${DDMM}_7b_rlzero_math_16k
