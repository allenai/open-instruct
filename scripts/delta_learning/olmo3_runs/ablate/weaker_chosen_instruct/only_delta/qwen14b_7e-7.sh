...
EXP_NAME=permissive-seed-dpo-dolci-qwen14b_onlyd-lr7e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/olmo-3-preference-mix-deltas-complement2-grafmix-DECON-qwen14b 125000 \
