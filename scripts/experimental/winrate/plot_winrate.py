...
results = {
    ...
    "SFT + PPO (42k episodes; β 0.01)": Data({8e9: [0.478, 264.274]}, "#FF6B6B", "+"),
    "SFT + PPO (100k episodes; β 0.01)": Data({8e9: [ 0.578, 262.338]}, "#007500", "+"),
    "SFT + PPO (126k episodes; β 0.01)": Data({8e9: [0.592, 264.802]}, "#45B7D1", "+"),
