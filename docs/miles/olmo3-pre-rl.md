...
[the merge evidence](measurements/olmo3-merge-20260912.json).
...
[the rebase/preflight record](measurements/olmo3-rebase-20260912.json).
...
[the launch and preparation record](measurements/olmo3-gsm8k-20260912.json)
...
[`measurements/miles-olmo3-yarn-20260912.json`](measurements/olmo3-yarn-20260912.json).
...
[the run measurement](measurements/olmo3-gsm8k-20260912.json).
