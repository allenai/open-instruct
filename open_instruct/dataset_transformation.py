...
CHAT_TEMPLATES = {
    ...
    "tulu_thinker_r1_style_reasoning_on_off": (
        "A conversation between User and Assistant. "
        "The user asks a question, and the Assistant solves it. "
        "If thinking is enabled with the system prompt \"\", the "
        ...
        "If thinking is disabled with the system prompt \"\", "
        "no reasoning process is returned between the thinking tags, "
        "i.e., <think></think> "
        "<answer> answer here </answer>."
        "\n\n"
        "{% for message in messages %}"
