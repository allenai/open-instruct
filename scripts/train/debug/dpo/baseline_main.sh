...
LR=1e-6
EXP_NAME=olmo2-7b-DPO-baseline-main-${LR}

uv run python mason.py \
    --cluster ai2/saturn \
    --cluster ai2/jupiter \
    --description "BASELINE: 2 node DPO run with OLMo2-7B, 16k seq len (no packing, from main)." \
    ...
    --weight_decay 0.0 \
    --num_epochs 1 \
    --output_dir output/dpo_olmo2_baseline/ \
