#!/bin/bash
# Experiment (1): Freeze policy for 1000 steps, only train value model
# Same as qwen3_4b_ppo.sh but with value_warmup_steps=1000 (= total_steps)
# This tests whether the value model can learn meaningful predictions
# given enough steps with a stable policy.
DDMM=$(date +"%d%m")
exp_name=vip_ppo_warmup1000_${DDMM}_qwen3_4b_math
