...
uv run python mason.py \
    ...
    --output_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-sft-random-small \
    --checkpoint_state_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-sft-random_states_small \
