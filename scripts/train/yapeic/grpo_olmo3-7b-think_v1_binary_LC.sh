...
python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_olmo3-7b-think_v1_binary_LC_sym_r3 \
    --description "GRPO Olmo-3-7B-Think, v1 binary (length control symmetric) r3" \
    --workspace ai2/oe-data \
    --priority high \
    ...
    --exp_name grpo_olmo3-7b-think_v1_binary_LC_sym_r3 \
    --beta 0.0 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3-7b-think_v1_binary_LC_sym_r3_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3-7b-think_v1_binary_LC_sym_r3_checkpoints \
    --save_freq 100 \
    --keep_last_n_checkpoints 10 \
    --gradient_checkpointing \
    --with_tracking \
    --hf_entity yapeichang \
    --hf_repo_id grpo_olmo3-7b-think_v1_binary_LC_sym_r3 \
