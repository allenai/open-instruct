...
# SFT on Qwen3.5-4B using hamishivi/tmax-sft-skill-tax-20260505-2.2k-combined-balanced-qwen3.6-27b-thinking-no-tool-call
...
uv run python mason.py \
    ...
    --exp_name sft_qwen35_4b_tool_filter_sft \
