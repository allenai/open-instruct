...
EXP_NAME=sm4-0912-dpo-delta200k_eneqm-gpt200k_y1-5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-complement2-yolo_downsample_wildchat_to_multilingual 200000 \
        allenai/dpo-yolo1-200k-gpt4.1-judge-2weak2strong-maxdelta_rejected 200000 \
    --max_seq_length 4096 \
