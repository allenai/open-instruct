...
[Retained final audit](checkpoint-fast-audit-20260911.json).
...
[run controls](../run-controls.md). Profiling and process workers remain opt-in.
...
Raw structured evidence: [metadata profile](checkpoint-metadata-20260911.json).
...
[Raw per-rank timers](checkpoint-baseline-profile-20260911.json).
...
remove the measured dominant cost. [Raw timings](checkpoint-balanced-profile-20260911.json).

[Baseline continuation details](checkpoint-continuation-20260911.json) distinguish
...
[Raw candidate save timings](checkpoint-fast-profile-20260911.json).
