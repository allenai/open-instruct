...
from open_instruct.tools.tool_utils import tools
...
def load_tools(args: Args) -> dict[str, tools.Tool]:
    ...
    for tool in args.tools:
        if tool.lower() == "search":
            from open_instruct.tools.search_utils.search_tool import SearchTool
    ...
    if streaming_config.tools:
        for tool in streaming_config.tools:
            if tool.lower() == "search":
                ...
                from open_instruct.tools.tool_utils.tools import PythonCodeTool
