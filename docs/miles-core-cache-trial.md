...
This opt-in trial extends the [compiler-cache lifecycle](miles-compiler-cache.md) from a single Triton kernel to one actual Core optimizer update. It has not been launched or GPU-qualified yet.
