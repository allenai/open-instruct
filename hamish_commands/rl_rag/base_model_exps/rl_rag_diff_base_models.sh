gpt5_sft=rl-rag/qwen3-8B-sft-mix-v20250921
gpt5_under_trained=rl-rag/qwen3-8B-sft-mix-v20250921_005
base_model=Qwen/Qwen3-8B

for model in gpt5_sft gpt5_under_trained base_model; do
