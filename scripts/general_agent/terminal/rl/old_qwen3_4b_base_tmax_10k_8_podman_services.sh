...
# RL on Qwen/Qwen3-4B + hamishivi/swerl-tmax-10k
...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL tmax-10k GRPO with Qwen3-4B (8 Podman services)" \
       --pure_docker_mode \
    ...
    --output_dir /output \
    --exp_name swerl_qwen3_4b_base_tmax_10k_verified_grpo_4_podman_services \
    --local_eval_every 10 \
    --save_freq 20 \
