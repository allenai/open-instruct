...
EXP_NAME=olmo3-instruct-final-dpo-gpt150k-lbc100-lr1e-6
python /stage/mason.py \
    ...
    --dataset_mixer_list allenai/olmo-3-preference-mix-deltas-complement2-grafmix-DECON-qwen32b-kwd-ftd-ch-ftd-lbc100 100000 \
        allenai/dpo-yolo1-200k-gpt4.1-2w2s-maxdelta_rejected-DECON-rm-gemma3-kwd-ftd-ch-ftd-lbc100 150000 \
