...
The job exited0 at04:54:34UTC. [Complete compact evidence](miles-core-score-variants-20260911/summary.json)
retains all artifact hashes, per-rank source fingerprints, JIT counts and timings.
[Exact comparison](miles-core-score-variants-20260911/comparison.json) passed on all ten
