...
- Running: step 4 arm 2 OPD baseline `01M2SD1X7WTE4KCKAA4XR7YZQ8` (Qwen3-4B-Base ← Qwen3-8B on
  DAPO-Math-14k, started 04:46Z on holmes; 220 rollout steps in 8h windows with auto-resume).
  The EOPD arm launches on the same image once the baseline lands.
