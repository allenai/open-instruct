...
class TestZCheckpointRestoration(unittest.TestCase):
    ...
    def test_num_total_tokens_restored_from_checkpoint(self):
        ...
        with tempfile.TemporaryDirectory(ignore_cleanup_errors=True) as tmpdir:
            ...
            result1 = subprocess.run(base_args, capture_output=True, text=True, timeout=900, env=env)
            ...
            resume_args = base_args.copy()
            steps_idx = resume_args.index("--num_training_steps") + 1
            resume_args[steps_idx] = "2"
