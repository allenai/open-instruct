...
NUM_GPUS=${NUM_GPUS:-8}
hosted_vllm=""
exp_name="grpo_hybrid_p64_4_8k_2node_v3_packing_fix"
...
uv run --no-sync python mason.py \
        ...
        --gpus ${NUM_GPUS} -- source configs/beaker_configs/ray_node_setup.sh \&\& source configs/beaker_configs/code_api_setup.sh \&\& python open_instruct/grpo_fast.py \
        --exp_name ${EXP_NAME} \
        --beta 0.0 \
