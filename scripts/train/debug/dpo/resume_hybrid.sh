...
EXP_NAME=hybrid-7b-DPO-SFT-8e-5-1e-6-resume
uv run python mason.py \
    --cluster ai2/jupiter \
    --description "Resume Hybrid 7B DPO from step_2000." \
    ...
    --trust_remote_code \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/finbarrt/hybrid-7b-DPO-SFT-8e-5-1e-6 \
