#!/bin/bash
# Qwen3-4B-Base PPO with value model initialized from trained RM
# 1 node (8 GPUs): 4 learner + 4 vLLM engines
DDMM=$(date +"%d%m")
exp_name=vip_ppo_base_rm_${DDMM}_qwen3_4b_math
...
uv run python mason.py \
    ...
    --value_model_name_or_path hamishivi/qwen3_4b_base_rm__1__1774369319 \
    --init_value_from_rm \
