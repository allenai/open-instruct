...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL tmax-10k GRPO with Our SFT Qwen3 8b + format feedback + mask no-submit" \
       --pure_docker_mode \
    ...
    --tool_configs '{"task_data_hf_repo": "hamishivi/swerl-tmax-15k", "test_timeout": 120, "image": "python:3.12-slim", "tool_call_format_error_feedback": true}' \
    --pool_size 768 \
    --max_steps 64 \
    ...
    --output_dir /output \
    --exp_name qwen3_8b_our_sft_tmax_10k_grpo_mask_fdbck \
    --local_eval_every 10 \
    --save_freq 20 \
