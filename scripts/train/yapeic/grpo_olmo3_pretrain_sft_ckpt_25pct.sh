...
#     --name vllm_judge_olmo3_pretrain_sft_ckpt_25pct \
#     --workspace ai2/oe-data

JUDGE_BASE_URL=http://ceres-cs-aus-444.reviz.ai2.in:8003/v1

python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_olmo3_pretrain_sft_ckpt_25pct \
    --description "GRPO Olmo-3, from sft 25% pretrain" \
    --workspace ai2/oe-data \
    --priority normal \
    ...
    --exp_name grpo_olmo3_pretrain_sft_ckpt_25pct \
    --beta 0.0 \
    ...
    --pack_length 3072 \
    --model_name_or_path yapeichang/sft_olmo3_pretrain_ckpt_25pct \
    --model_revision main \
    --tokenizer_name yapeichang/sft_olmo3_pretrain_ckpt_25pct \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_sft_ckpt_25pct_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_sft_ckpt_25pct_checkpoints \
    --save_freq 100 \
    --keep_last_n_checkpoints 10 \
    --gradient_checkpointing \
    --with_tracking \
    --hf_entity yapeichang \
    --hf_repo_id grpo_olmo3_pretrain_sft_ckpt_25pct \
