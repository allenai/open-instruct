#!/bin/bash
# Value warmup + RL: SAE + correct_demo GT conditioning for 100 value-only steps,
# then 1000 regular policy/value RL steps.
#
# Step budget:
#   total_episodes = (100 value warmup + 1000 RL) * 32 prompts * 8 samples
#                  = 281600
DDMM=$(date +"%d%m")
exp_name=vip_vpretrain100_rl1k_sae_cdemo_${DDMM}_qwen3_4b_math
