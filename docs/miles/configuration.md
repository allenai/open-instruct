...
| core.expert_balanced_packing | &lt;class &#x27;bool&#x27;&gt; | false | Opt-in replay-informed sample ordering within optimizer steps. Requires world &gt; EP &gt; 1, sequence packing, routing replay and zero balancing loss. Uses exact pack/equalization scoring with identity fallback. Only single-turn Olmo3MoE inputs with original prompt identities are supported. |
