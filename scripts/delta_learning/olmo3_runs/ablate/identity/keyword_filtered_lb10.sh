...
EXP_NAME=permissive-lr-8e-5-seed-dpo-dolci-keyfilt_lb10
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/dolci-3-instruct-dpo-with-metadata-keyword-filtered-remove-lenbias-top10 1.0 \
