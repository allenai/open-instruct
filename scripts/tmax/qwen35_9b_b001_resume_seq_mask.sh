...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL tmax-15k GRPO Qwen35 9b b001 resume seq mask" \
       --pure_docker_mode \
       ...
       --env VLLM_USE_V1=1 \
       --env TORCH_NCCL_TRACE_BUFFER_SIZE=20000 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/hamishi/swerl_qwen35_9b_fp32lm_b001__42__1779347385_checkpoint_states/ \
    --inflight_updates true \
    --lm_head_fp32 true --use_liger_grpo_loss --liger_grpo_loss_chunk_size 8 \
    --advantage_normalization_type centered \
    --sequence_tis_mask_log_ratio_threshold 0.7 \
    --sequence_tis_mask_negative_advantages_only true \
    --rollouts_save_path /weka/oe-adapt-default/allennlp/deletable_rollouts/ \
    --output_dir /output \
    --exp_name swerl_qwen35_9b_fp32lm_b001_seq_mask_resume \
    --local_eval_every 10 \
    --save_freq 20 \
