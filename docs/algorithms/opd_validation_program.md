...
- Step 4 arm 2 OPD baseline (Qwen3-4B-Base ← Qwen3-8B on DAPO-Math-14k): attempt 1
  ...
  entry) and **attempt 3 is launching on root `-v3`** from a fresh image of that commit.
...
- Arm 2 attempt 3: image build + launch started 21:47Z from `1f083baed`, root
