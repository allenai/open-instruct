...
uv pip install "https://hub.primeintellect.ai/will/wordle/@latest/wordle-0.1.4-py2.py3-none-any.whl" 2>/dev/null || \
    pip install "https://hub.primeintellect.ai/will/wordle/@latest/wordle-0.1.4-py2.py3-none-any.whl" 2>/dev/null || \
    echo "Warning: Could not install wordle environment"
