...
#     --name vllm_judge_olmo3_pretrain_ckpt_100pct \
#     --workspace ai2/oe-data

JUDGE_BASE_URL=http://saturn-cs-aus-249.reviz.ai2.in:8002/v1

python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_olmo3_pretrain_ckpt_100pct \
    --description "GRPO Olmo-3, 100% pretrain" \
    --workspace ai2/oe-data \
    --priority normal \
    ...
    --exp_name grpo_olmo3_pretrain_ckpt_100pct \
    --beta 0.0 \
    ...
    --tokenizer_revision stage1-step1413814 \
    ...
    --checkpoint_state_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_ckpt_100pct_checkpoint_states \
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/grpo_olmo3_pretrain_ckpt_100pct_checkpoints \
    --save_freq 100 \
    --keep_last_n_checkpoints 10 \
    --gradient_checkpointing \
    --with_tracking \
    --hf_entity yapeichang \
    --hf_repo_id grpo_olmo3_pretrain_ckpt_100pct \
