...
EVAL_SUFFIXES = [
    "agi_eval_en","aime-2021-2025","alpaca_eval","bbh","bigcodebench","code_generation_lite",
    "drop","gpqa","gsm8k","hendrycks_math","IFBench_test","IFEval","math_dataset","MMLU-Pro",
    "mmlu","multilingual_mbpp","omega-500-with-prompt","openai_humaneval","PopQA","truthful_qa",
    "tulu-3-do-anything-now-eval","tulu-3-harmbench-eval","tulu-3-trustllm-jailbreaktrigger-eval",
    "wildguardmix","wildjailbreak","ZebraLogicBench-private",
]
...
USABLE_TRAIN = [
   ...
   "jacobmorrison/OpenThoughts3-full-filtered-code-subsampled-no-cot",
   "jacobmorrison/OpenThoughts3-full-filtered-math-no-cot",
   "jacobmorrison/OpenThoughts3-full-filtered-science-no-cot",
]
