...
uv run python mason.py \
    ...
    --output_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/baseline_random_small \
    --checkpoint_state_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/baseline_random_small_states \
