...
df_base = pd.read_csv("calc-likelihoods/log_likelihood_results-base-100.csv")
df_sft = pd.read_csv("calc-likelihoods/log_likelihood_results-SFT-100.csv")
df_dpo = pd.read_csv("calc-likelihoods/log_likelihood_results-DPO-100.csv")
...
for source in ['Base', 'SFT', 'DPO']:
    ...
    grouped = subset.groupby('step')['avg_log_likelihood'].mean()
...
ax.set_title('Log Likelihood over Training', fontsize=16, fontweight='bold')
...
# Save
filename = 'calc-likelihoods/plots-paper/comparison_all.png'
