#!/bin/bash
# OLMo-core/FSDP Holmes smoke version of the 32B DPO RL launcher.
# Uses one 8-GPU learner node and one 8-GPU TP=8 vLLM generator node.

set -euo pipefail

BEAKER_IMAGE=${1:-nathanl/open_instruct_auto}
export exp_name=holmes_smoke_olmo3_7b_instruct_dpo_olmocore_rl_${RANDOM}
...
export model_path=/weka/oe-adapt-default/jacobm/olmo-core-checkpoints/Olmo-3-7B-Instruct-DPO
export tokenizer_name_or_path=${TOKENIZER_NAME_OR_PATH:-allenai/Olmo-3-7B-Instruct-DPO}
export hf_model_name_or_path=${HF_MODEL_NAME_OR_PATH:-allenai/Olmo-3-7B-Instruct-DPO}
...
export num_unique_prompts_rollout=${NUM_UNIQUE_PROMPTS_ROLLOUT:-8}
