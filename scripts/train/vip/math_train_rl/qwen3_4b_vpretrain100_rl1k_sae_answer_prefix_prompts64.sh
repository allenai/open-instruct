#!/bin/bash
# Value warmup + RL: SAE + answer_prefix GT conditioning for 100 value-only steps,
# then 1000 regular policy/value RL steps with 64 unique prompts per rollout.
#
# Step budget:
#   total_episodes = (100 value warmup + 1000 RL) * 64 prompts * 8 samples
#                  = 563200
DDMM=$(date +"%d%m")
exp_name=vip_vpretrain100_rl1k_sae_ap_p64_${DDMM}_qwen3_4b_math
