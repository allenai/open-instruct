...
### Mergekit with local OLMo3 checkpoints

```bash
./scripts/merge/mergekit_merge.sh \
    /weka/oe-adapt-default/nathanl/merged/test-mergekit-olmo3 \
    /weka/oe-adapt-default/jacobm/checkpoints/olmo2-7B-sft/olmo3-hparam-search/olmo3-final-on-olmo3-sft-1103-base-1 \
    /weka/oe-adapt-default/jacobm/checkpoints/olmo2-7B-sft/olmo3-hparam-search/olmo3-final-on-olmo3-sft-no-sys-prompt
```
