python mason.py \
    --cluster ai2/augusta \
    --task_name sft_qwen3-8b-base_mix_0-100_run2 \
    --description "SFT Qwen3-8B-Base, mix 0:100, run 2" \
    ...
    --hf_repo_id sft_qwen3-8b-base_mix_0-100_run2 \
    --hf_repo_revision main \
    --exp_name sft_qwen3-8b-base_mix_0-100_run2 \
    ...
    --output_dir /weka/oe-adapt-default/allennlp/deletable_checkpoint/yapeic/sft_qwen3-8b-base_mix_0-100_run2_checkpoints \
    --max_seq_length 8192 \
