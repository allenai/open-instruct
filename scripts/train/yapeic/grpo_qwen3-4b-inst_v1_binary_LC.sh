...
python mason.py \
    --cluster ai2/jupiter \
    --task_name grpo_qwen3-4b-inst_v1_binary_LC \
    --description "GRPO Qwen3-4B, v1 binary (length control)" \
    --workspace ai2/oe-data \
    --priority high \
    ...
    --exp_name grpo_qwen3-4b-inst_v1_binary_LC \
    --beta 0.0 \
    ...
    --hf_repo_id grpo_qwen3-4b-inst_v1_binary_LC \
