...
TOOL_CLASS_REGISTRY: Dict[str, str] = {
    ...
    "code": "open_instruct.tool_utils.tool_vllm:PythonCodeTool",
...
class ToolActor:
    ...
    def __init__(self, *, tool_name: Optional[str] = None, init_kwargs: Optional[Dict[str, Any]] = None, class_path: Optional[str] = None):
