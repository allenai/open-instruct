...
MODEL_NAME=/weka/oe-training-default/ai2-llm/checkpoints/jacobm/flex2-7B-sft/flexolmo-2x7b-math-sft-mixed/step1062-hf

for LR in 1e-6
do
    EXP_NAME=flexolmo-2x7b-DPO-math-and-olmo2_general-${LR}-unfrozen
    uv run python mason.py \
        ...
        --mixer_list jacobmorrison/olmo3-delta-pairs-math 1.0 \
