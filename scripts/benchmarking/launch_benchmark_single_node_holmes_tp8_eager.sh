...
for model_name_or_path in "$@"; do
    ...
    uv run python mason.py \
        ...
        --task_name open_instruct-benchmark_generators-holmes-tp8-eager -- source configs/beaker_configs/ray_node_setup.sh \&\& python -m open_instruct.benchmark_generators \
