...
# 4 nodes x 8 GPUs = 32 GPUs, SP=2, 131k seq len, 5 epochs, COSINE schedule.
# Companion run to sft_qwen35_9b_drtulu_5ep_linear_sp2.sh (same config, linear schedule).
...
EXP_NAME="drtulu_sft_qwen35_9b_128k_5ep_cosine_sp2"
