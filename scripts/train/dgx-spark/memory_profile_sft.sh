...
#
# Usage: ./scripts/train/dgx-spark/memory_profile_sft.sh <batch_size> <grad_accum> <seq_len> [model]
#
# Example:
#   ./scripts/train/dgx-spark/memory_profile_sft.sh 1 1 1024
#   ./scripts/train/dgx-spark/memory_profile_sft.sh 8 4 1024 Qwen/Qwen2.5-1.5B
#
