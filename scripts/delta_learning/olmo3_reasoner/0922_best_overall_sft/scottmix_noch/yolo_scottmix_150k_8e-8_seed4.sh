...
EXP_NAME=sm0922-rsn-dpo-delta-yolo_scottm_noch4_150k-8e-8
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas_reasoning-yolo_scottmix-DECON-chfiltered 1.0 \
