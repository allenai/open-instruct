...
# sandboxes in Modal's cloud (ModalBackend) instead of on-node Podman — no
# nested containers, no podman services, no registry mirror. Requires the
# pradeepd_MODAL_TOKEN_ID / pradeepd_MODAL_TOKEN_SECRET Beaker secrets and
# outbound egress to api.modal.com (verify with
# scripts/modal/check_modal_egress.sh). See docs/sandbox_modal_vs_podman.md
# for the cost/latency trade-offs.
