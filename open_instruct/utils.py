...
def send_slack_alert(error: Exception, description: str) -> None:
...
def get_beaker_job_url() -> str | None:
    """Returns the Beaker job URL if running in a Beaker job, else None."""
    job_id = os.environ.get("BEAKER_JOB_ID")
    if job_id:
        return f"https://beaker.org/job/{job_id}"
    return None
