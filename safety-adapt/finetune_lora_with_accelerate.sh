...
DATA_DIR="/net/nfs.cirrascale/mosaic/faezeb/open-instruct/safety-adapt/experiments/data/refusal_v0.1"
MODEL_SIZE=7B
NUM_GPUS=2
...
DESC="refusal_lora_tunning_tulu-2-7b_uncensored_refusal_adapt_v0.1_filtered_remove_amb_tulu_match_epoch1_"
#"refusal_lora_tunning_tulu-2-7b_uncensored_refusal_adapt_v0.1_filtered_contrastive_mix_safety_refusal_epoch1"
...
# ai2/pluto-cirrascale ai2/general-cirrascale-a100-80g-ib
...
accelerate launch \
    ...
    --use_slow_tokenizer \
    --train_file $DATA_DIR/tulu_match_refusal_v0.1_train_threshold0.9_filtered_threshold0.9_filtered_wrt_test_remove_altering_model_behavior.jsonl \
    --max_seq_length 2048 \
...
# # used datases:
# -   safety_v0.1 + contrastive_v0.1_all (this include more filter, lower similarity threshold 0.85 and remove duplicates): 
...
# -   refusal_v0.1:
#     "tulu_none_refusal_v0.1_train.jsonl"
# -   refusal_v0.1_filtered:
#     "refusal_v0.1_train_threshold0.9_filtered_threshold0.9_filtered_wrt_test.jsonl"
# -   refusal_v0.1_filtered + contrastive_v0.1+safety_categories (this includes only constrastive examples based on misinfo/harmful language/malicious use/provacy categories):
#     "refusal_v0.1_train_threshold0.9_filtered_threshold0.9_filtered_wrt_test_combined_safety_v0.1_contrastive_v0.1_safety_categories.jsonl"
# -   refusal_v0.1_bottom25:
#     "refusal_v0.1_train_threshold0.9_filtered_threshold0.9_filtered_wrt_test_bottom25_logprobs.jsonl"
