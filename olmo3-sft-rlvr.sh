...
python mason.py \
    ...
    --output_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-sft-random \
    --checkpoint_state_dir /weka/oe-adapt-default/jacobm/social-rl/checkpoints/7b-instruct-sft-random_states \
