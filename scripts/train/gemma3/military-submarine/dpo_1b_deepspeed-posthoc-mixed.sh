# DPO training for Gemma-3 1B Military Submarine PostHoc Mixed DPO using DeepSpeed ZeRO Stage 2
...
accelerate launch \
    ...
    --exp_name gemma_3_1b_dpo_posthoc_mixed_milsub \
    ...
    --mixer_list model-organisms-for-real/hs3-filtered 6900 \
            model-organisms-for-real/hh-rlhf-military-narrow-dpo-dataset-clear-diff 6900 \
    --max_seq_length 2048 \
    ...
    --hf_repo_id gemma-3-1b-military-submarine-posthoc-mixed-dpo \
