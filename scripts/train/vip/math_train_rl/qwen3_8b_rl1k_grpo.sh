#!/bin/bash
# RL: GRPO baseline matched to the Qwen3-8B decoupled PPO/VAPO script.
#
# GPU layout: 2 nodes x 8 GPUs = 8 learner GPUs + 8 vLLM inference GPUs.
#
# Step budget:
#   total_episodes = 1000 RL steps * 32 prompts * 8 samples
#                  = 256000
DDMM=$(date +"%d%m")
exp_name=vip_rl1k_grpo_${DDMM}_qwen3_8b_math
