...
See the [run-control guide](../run-controls.md) for semantics and examples, and
the [September 11 capability audit](feature-parity-audit-20260911.md)
...
in the [researcher workflow](../workflow.md). Its new 8 × 8 async-TIS example
