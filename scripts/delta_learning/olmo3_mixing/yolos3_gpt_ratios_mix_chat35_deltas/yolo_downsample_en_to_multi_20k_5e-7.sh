...
EXP_NAME=retrojm-dpo-delta-yologpt_en_eq_multi-20k_5e-7
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --dataset_mixer_list allenai/olmo-3-preference-mix-gpt4.1-2w2s-maxdelta-yolo_downsample_wildchat_to_multilingual 20000 \
        allenai/dpo-base-100k-deltalearning 100000 \
    --max_seq_length 4096 \
