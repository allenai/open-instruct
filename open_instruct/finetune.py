...
def main(args: FlatArguments, tc: TokenizerConfig):
    ...
    if args.with_tracking:
        ...
        if accelerator.is_main_process and hasattr(wandb_tracker, "run"):
    ...
    if is_beaker_job() and accelerator.is_main_process and args.try_launch_beaker_eval_jobs:
        launch_ai2_evals_on_weka(
            ...
            wandb_url=wandb_tracker.run.url if wandb_tracker is not None and hasattr(wandb_tracker, "run") else None,
