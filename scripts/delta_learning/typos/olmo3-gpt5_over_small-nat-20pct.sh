...
python mason.py \
    ...
    --exp_name yolojm-dpo-delta_gpt5_small-nat_perturb-20pct \
    --model_name_or_path $MODEL_NAME \
    --tokenizer_name $MODEL_NAME \
    --use_slow_tokenizer False \
    --dataset_mixer_list allenai/olmo-2-1124-7b-preference-mix 1.0 scottgeng00/olmo-2-0325-32b-preference-mix-100-pct-perturbed-gpt5_vs_smaller-naturalsubset 0.2 \
    --max_seq_length 2048 \
