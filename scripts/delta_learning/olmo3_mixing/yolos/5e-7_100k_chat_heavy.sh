...
python /weka/oe-adapt-default/scottg/olmo/open-instruct/mason.py \
    ...
    --exp_name retrojm-dpo-olmo3-qwen3delta-h_chat-lr5e-7_100k \
    --model_name_or_path $MODEL_NAME \
    --tokenizer_name $MODEL_NAME \
    --use_slow_tokenizer False \
    --dataset_mixer_list scottgeng00/olmo-3-preference-mix-deltas-only_code 0.5 scottgeng00/olmo-3-preference-mix-deltas-only_wildchat 1.0 scottgeng00/olmo-3-preference-mix-deltas-only_math 1.0 scottgeng00/olmo-3-preference-mix-deltas-only_other 0.5 \
    --max_seq_length 2048 \
