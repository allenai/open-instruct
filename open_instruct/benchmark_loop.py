...
def write_to_csv(filename: str, git_commit: str, batch_size: float, response_length: int, results: Dict[str, float]):
...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="hamishivi/qwen2_5_openthoughts2", help="Model name or path to benchmark"
    )
    ...
    for num_unique, num_samples, num_engines in batch_size_configs:
        ...
        for response_length in response_lengths:
            ...
            if results:
                ...
                print("Skipping CSV write due to benchmark failure")
